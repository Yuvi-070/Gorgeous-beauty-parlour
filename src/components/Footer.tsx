        ...
        <div>
          ...
          <ul className="space-y-2">
            {[{href:"/",l:"Home"},{href:"/about",l:"About Us"},{href:"/amenities",l:"Amenities"},{href:"/contacts",l:"Contact"}].map(({href,l}) => (
              <li key={href}><Link href={href} className="text-sm hover:text-pink-400 transition-colors">{l}</Link></li>
            ))}
          </ul>
        </div>
        <div>
          ...
          <address className="not-italic text-sm text-gray-400 space-y-2">
            ...
            <p><a href="tel:+919822186362" className="hover:text-pink-400">+91 9822186362</a></p>
            <p><a href="tel:+917219636275" className="hover:text-pink-400">+91 7219636275</a></p>
            <p><a href="mailto:truptitale305@gmail.com" className="hover:text-pink-400">truptitale305@gmail.com</a></p>
          </address>
        </div>
      </div>
      <div className="border-t border-gray-700 py-4 text-center text-xs text-gray-500">
        <p>&copy; {new Date().getFullYear()} Gorgeous Beauty Parlour. All rights reserved.</p>
        <p className="mt-1">Designed by <a href="https://www.linkedin.com/in/yuvraj-tale-m0705/" target="_blank" rel="noopener noreferrer" className="text-pink-400 hover:text-pink-300">Yuvraj Tale</a></p>
      </div>
    </footer>
  );
}
