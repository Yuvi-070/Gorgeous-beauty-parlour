  ...
  return (
    <section className="py-24 bg-rg-50/80">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <p className="text-rg-500 text-xs tracking-[0.35em] uppercase mb-3">Testimonials</p>
        ...
        <div className={`transition-opacity duration-300 ${animating ? "opacity-0" : "opacity-100"}`}>
          <div className="flex flex-col items-center bg-white/95 border border-rg-100/80 rounded-3xl px-6 py-10 md:px-14 md:py-14 shadow-2xl shadow-rg-200/50 relative">
            ...
            <div className="relative w-28 h-28 rounded-full overflow-hidden mb-6 ring-4 ring-rg-200 shadow-xl">
              <Image
            ...
            <p className="text-rg-400 text-xs tracking-widest uppercase mt-1">Valued Client</p>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center gap-6 mt-8">
          <button
            ...
            className="h-12 w-12 rounded-full bg-white border border-rg-200/70 text-rg-700 shadow-md hover:bg-rg-50 hover:shadow-lg hover:scale-110 transition-all duration-200 flex items-center justify-center text-2xl"
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                className={`rounded-full transition-all duration-300 ${
                  i === current ? "bg-rg-500 w-8 h-2.5" : "bg-rg-200 w-2.5 h-2.5 hover:bg-rg-300"
                }`}
