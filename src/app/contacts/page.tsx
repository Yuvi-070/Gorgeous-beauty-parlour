    ...
    <>
      ...
      <section className="py-24 bg-white/90">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white/90 border border-rose-100/80 rounded-3xl shadow-2xl shadow-rose-200/40 p-6 md:p-8">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-8">Send a Message</h2>
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">First Name</label>
                  <input type="text" className="w-full border border-rose-200/80 bg-rose-50/50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400" placeholder="Jane" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                  <input type="text" className="w-full border border-rose-200/80 bg-rose-50/50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400" placeholder="Doe" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                <input type="email" className="w-full border border-rose-200/80 bg-rose-50/50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400" placeholder="jane@example.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Phone</label>
                <input type="tel" className="w-full border border-rose-200/80 bg-rose-50/50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400" placeholder="+91 XXXXXXXXXX" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Service</label>
                <select className="w-full border border-rose-200/80 bg-rose-50/50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400">
              ...
              <div>
                ...
                <textarea rows={4} className="w-full border border-rose-200/80 bg-rose-50/50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400" placeholder="Tell us how we can help..."></textarea>
              </div>
              <button type="submit" className="w-full bg-rose-600 hover:bg-rose-700 text-white text-xs font-semibold tracking-[0.2em] uppercase py-3 rounded-full transition-colors duration-300 shadow-lg shadow-rose-200/40">
                Send Message
              </button>
            </form>
          </div>
