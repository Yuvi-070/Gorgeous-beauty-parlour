  ...
  return (
    <>
      ...
      <section className="py-24 bg-white/90">
        <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-14 items-center">
      ...
      <section className="py-24 bg-white/90">
        <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8">
